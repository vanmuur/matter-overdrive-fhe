...
public class BlockMatterRecycler extends MOMatterEnergyStorageBlock<TileEntityMachineMatterRecycler> {
    ...
    public enum RecycleState implements IStringSerializable {
        RECYCLE_OFF(0, "off"),
        RECYCLE_ON(1, "on");
        ...
        private RecycleState(int ID, String name) {
            this.ID = ID;
            this.name = name;
        }
    ...
    public static final PropertyEnum<RecycleState> RECYCLING = PropertyEnum.create("recycling", RecycleState.class);
...
/*
    ...
    public BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, PROPERTY_DIRECTION, RECYCLING);
    }
}
